...
parser.add_argument('--test_dir', dest='test_dir', default='./data/test/input', help='directory for testing inputs')
...
def main(_):
    if args.use_gpu:
        ...
        gpu_options = tf1.GPUOptions(per_process_gpu_memory_fraction=args.gpu_mem)
